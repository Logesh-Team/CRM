...
/**
 * Provider that provides tenant-specific connection handling in a multi-tenant
 * application. The tenant
 * distinction is realized by using separate schemas, i.e. each tenant uses its
 * own schema in a shared
 * (common) database.
 */
@Component
