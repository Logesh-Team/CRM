...
import com.vyg.eis.CRM.CRMApplication;
...
/**
 * Configures an {@link LocalContainerEntityManagerFactoryBean
 * EntityManagerFactoryBean} for a schema-based multi-tenant
 * data source.
 */
@Configuration
public class MultiTenantSchemaHibernateConfiguration {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        em.setPackagesToScan(CRMApplication.class.getPackage().getName());
